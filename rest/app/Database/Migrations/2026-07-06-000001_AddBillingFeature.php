...
class AddBillingFeature extends Migration
{
    protected $DBGroup = 'platform';

    private const FEATURE_KEY = 'billing';
    ...
    public function up()
    {
        ...
        if ($this->db->fieldExists('icon_class', 'platform_features')) {
            $payload['icon_class'] = 'fa-calculator';
        }
        ...
        if ($this->db->fieldExists('icon_class', 'platform_features')) {
            $update['icon_class'] = 'fa-calculator';
        }
