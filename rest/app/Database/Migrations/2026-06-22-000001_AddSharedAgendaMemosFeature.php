...
class AddSharedAgendaMemosFeature extends Migration
{
    protected $DBGroup = 'platform';

    private const FEATURE_KEY = 'shared_agenda_memos';
    ...
    public function up()
    {
        ...
        if (!$feature) {
            $payload = [
                ...
                'feature_name' => 'Memo condivise tra dottori',
                'feature_scope' => 'workflow',
                'description' => 'Il tenant master decide se i dottori dello spazio possono vedere e gestire tutte le memo agenda del team oppure solo quelle personali.',
                'default_enabled' => 0,
                'created_at' => $now,
                'updated_at' => $now,
            ];
            ...
            if ($this->db->fieldExists('icon_class', 'platform_features')) {
                $payload['icon_class'] = 'fa-sticky-note';
            }
            ...
            if ($this->db->fieldExists('icon_class', 'platform_features')) {
                $update['icon_class'] = 'fa-sticky-note';
            }
