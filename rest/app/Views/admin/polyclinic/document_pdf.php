      ...
      <div class="col-50 right">
        <div class="box">
          <table class="totals">
            ...
            <?php $taxAmount=round((float)($document['amount_total']??0)-(float)($document['subtotal_amount']??0)-(float)($document['stamp_duty_amount']??0),2); if ($taxAmount>0): ?>
            <tr><td>IVA</td><td>EUR <?= number_format($taxAmount,2,',','.') ?></td></tr>
            <?php endif ?>
