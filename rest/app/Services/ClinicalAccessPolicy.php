...
{
    public function __construct(private BaseConnection $db, private int $userId) {}
    public function actor(): array
    {
        ...
        if (!$staff || (isset($staff['is_active']) && !(int)$staff['is_active']) || !in_array((int) $staff['tipo'], [1,2,3], true)) throw new \RuntimeException('Profilo non abilitato alla cartella clinica.');
