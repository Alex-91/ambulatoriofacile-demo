...
$routes->get('login/piattaforma/impersonificazione', 'Login\PlatformImpersonationController::index');
...
$routes->get('login/piattaforma/chatbot-whatsapp', 'Login\PlatformWhatsAppChatbotController::index');
$routes->post('login/piattaforma/chatbot-whatsapp/save', 'Login\PlatformWhatsAppChatbotController::save');
...
$routes->post('login/spazio/sistema-ts/healthcheck', 'Tenant\TsSettingsController::healthcheck');
...
$routes->get('login/spazio/notifiche-appuntamenti/whatsapp/refresh', 'Tenant\AppointmentNotifications::whatsappRefresh');
$routes->post('login/spazio/notifiche-appuntamenti/whatsapp/pair', 'Tenant\AppointmentNotifications::whatsappPair');
...
$routes->get('piattaforma/impersonificazione', 'Login\PlatformImpersonationController::index');
$routes->post('piattaforma/impersonificazione/start', 'Login\PlatformImpersonationController::start');
$routes->post('piattaforma/impersonificazione/stop', 'Login\PlatformImpersonationController::stop');
...
$routes->get('piattaforma/chatbot-whatsapp', 'Login\PlatformWhatsAppChatbotController::index');
$routes->post('piattaforma/chatbot-whatsapp/save', 'Login\PlatformWhatsAppChatbotController::save');
...
$routes->post('spazio/sistema-ts/healthcheck', 'Tenant\TsSettingsController::healthcheck');
...
$routes->get('spazio/notifiche-appuntamenti/whatsapp/refresh', 'Tenant\AppointmentNotifications::whatsappRefresh');
$routes->post('spazio/notifiche-appuntamenti/whatsapp/pair', 'Tenant\AppointmentNotifications::whatsappPair');
...
$routes->post('api/smsfactor/dlr', 'Api\SmsFactorWebhookController::deliveryReport');
$routes->post('demo/api/smsfactor/dlr', 'Api\SmsFactorWebhookController::deliveryReport');
$routes->post('login/api/smsfactor/dlr', 'Api\SmsFactorWebhookController::deliveryReport');
...
$routes->post('cartella-clinica/pazienti/(:num)/pacs/richieste/(:segment)/modifica', 'PacsOrdersController::update/$1/$2');
...
$routes->post('cartella-clinica/pazienti/(:num)/pacs/studi/(:segment)/visualizzatore', 'PacsController::viewer/$1/$2');
$routes->post('cartella-clinica/pazienti/(:num)/pacs/studi/(:segment)/scarica', 'PacsController::download/$1/$2');
