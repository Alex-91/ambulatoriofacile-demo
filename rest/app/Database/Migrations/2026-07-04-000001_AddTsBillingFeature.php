...
class AddTsBillingFeature extends Migration
{
    ...
    public function up()
    {
        ...
        if ($this->db->fieldExists('icon_class', 'platform_features')) {
            $payload['icon_class'] = 'fa-file-text-o';
        }
        ...
        if ($this->db->fieldExists('icon_class', 'platform_features')) {
            $update['icon_class'] = 'fa-file-text-o';
        }
