...
class SpaceFeatures extends BaseController
{
    ...
    public function index()
    {
        ...
        $agendaDefaultViewSettings = (new AgendaDefaultViewService())
            ->resolveTenantSettings($context->tenantId);
        ...
        return view('tenant/space_features', [
            ...
            'administrationAccessible' => (bool)(new \App\Services\AdministrationFeatureService())->available($context->tenantId),
    ...
    public function save()
    {
        ...
        try {
            ...
            if ($agendaDefaultViewForm) {
                (new AgendaDefaultViewService())->saveTenantPreferences(
                    $context->tenantId,
                    $agendaDefaultViewEnabled,
                    $agendaDefaultView,
                    $platformUserId
                );
            }
