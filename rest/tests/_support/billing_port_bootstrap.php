...
$_SERVER['HTTP_HOST'] = 'billing-synthetic.invalid';
$_SERVER['app.baseURL'] = 'http://billing-synthetic.invalid/';
...
final class BillingSyntheticBoot extends \CodeIgniter\Boot
{
...
BillingSyntheticBoot::bootTest($syntheticPaths);
require __DIR__ . '/billing_synthetic_database.php';
