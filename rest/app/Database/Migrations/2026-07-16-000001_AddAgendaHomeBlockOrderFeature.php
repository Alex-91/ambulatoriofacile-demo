...
class AddAgendaHomeBlockOrderFeature extends Migration
{
    protected $DBGroup = 'platform';

    private const FEATURE_KEY = 'agenda_home_block_order';
    ...
    public function up()
    {
        ...
        if ($this->db->fieldExists('icon_class', 'platform_features')) {
            $payload['icon_class'] = 'fa-th-large';
        }
