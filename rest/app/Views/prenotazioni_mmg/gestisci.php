...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?= esc('AmbulatorioFacile') ?> | Gestisci prenotazioni MMG</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1>Gestisci prenotazioni MMG</h1>
          <ol class="breadcrumb">
            ...
            <div class="box-body">
              <?php if (empty($existing)): ?>
                <div class="alert alert-info">
                  ...
                  <a href="<?= site_url('prenotazioni/mmg/nuova') ?>" class="btn btn-success btn-sm" style="margin-left:8px;">
              ...
              <?php else: ?>
                <p>
                  <b>Medico:</b>
                  <?= esc(($existing['cognome_med'] ?? '')) ?> <?= esc(($existing['nome_med'] ?? '')) ?><br>

                  <b>Quando:</b>
                  <?= esc(formatDataOraIt($existing['data_ora_ini'] ?? '')) ?>
                </p>

                <hr>

                <form method="post"
                    action="<?= site_url('prenotazioni/mmg/cancella') ?>"
