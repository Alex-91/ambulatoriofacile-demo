      ...
      <div class="row">
        ...
        <div class="col-md-9">
              ...
              <form method="post" action="<?= site_url('admin/personale/dap14/update') ?>">
                ...
                <div class="box-body">
                  <p class="text-muted" style="margin-bottom:14px;">
                    I medici già presenti nell'abbinamento <code>dap14_seg_dot</code> risultano già selezionati. Puoi aggiungere o togliere i collegamenti e poi salvare.
                  </p>
          ...
          <?php elseif ($selectedSecretaryId <= 0): ?>
            <div class="alert alert-info">
              Seleziona una segretaria per vedere quali medici può gestire e quali risultano già collegati.
            </div>
          <?php endif; ?>
        </div>
      </div>
