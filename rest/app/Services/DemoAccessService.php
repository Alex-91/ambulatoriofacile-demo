    ...
    public function presentationAccounts(): array
    {
        return [
            ...
            [
                ...
                'note' => 'Apre direttamente l\'agenda con 3 professionisti visibili e Giorno Team già selezionato per mostrare la nuova vista condivisa.',
            ...
            [
                ...
                'note' => 'Simula un accesso standard dello studio: entra nell\'operatività dello spazio senza permessi da responsabile e poi puoi cambiare ruolo dalla demo.',
                'redirect_route' => 'agenda',
                'prefer_account_redirect' => true,
                'scenarios' => ['utente normale', 'operatività studio', 'agenda studio'],
            ],
            [
                'group_key' => 'main',
            ...
            [
                ...
                'note' => 'Utile per provare permessi differenziati e convivenza tra più professionisti nello stesso studio demo.',
                'redirect_route' => 'agenda',
            ...
            [
                ...
                'group_note' => 'Percorso parallelo utile per far vedere che la stessa base regge un secondo scenario demo già popolato.',
                'account_type' => 'legacy',
