...
$routes->get('login/spazio/whatsapp', 'Tenant\WhatsAppConversations::index');
$routes->get('login/spazio/whatsapp/refresh', 'Tenant\WhatsAppConversations::refresh');
$routes->post('login/spazio/whatsapp/send', 'Tenant\WhatsAppConversations::send');
...
$routes->get('spazio/whatsapp', 'Tenant\WhatsAppConversations::index');
$routes->get('spazio/whatsapp/refresh', 'Tenant\WhatsAppConversations::refresh');
$routes->post('spazio/whatsapp/send', 'Tenant\WhatsAppConversations::send');
