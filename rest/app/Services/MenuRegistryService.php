...
class MenuRegistryService
{
    ...
    public function tenantAdminCatalog(): array
    {
        return [
            ...
            [
                ...
                'default' => true,
                'group' => 'Menu operativo',
                'description' => 'Cerca, aggiorna e gestisci l’anagrafica clienti già presenti.',
                'route_prefixes' => [
            ...
            [
                ...
                'default' => false,
                'group' => 'Menu operativo',
                'description' => 'Crea, firma, valida e pubblica referti nel Fascicolo Sanitario Elettronico.',
                'route_prefixes' => ['admin/fse2'],
            ],
            [
                ...
                'default' => false,
                'group' => 'Menu operativo',
                'description' => 'Analizza il fatturato ed esporta i dati filtrati per il commercialista.',
                'route_prefixes' => [
                    'admin/fatturazione-statistiche',
                    'admin/fatturazione-statistiche/export',
                    'admin/fatturazione-statistiche/export-pdf',
                ],
            ],
            [
    ...
    public function tenantContextCatalog(): array
    {
        return [
            ...
            [
                'key' => 'spazio/fse2',
                'link' => 'spazio/fse2',
                'title' => 'Configura FSE 2.0',
                'icon' => 'fa-medkit',
                'order' => 2170,
                'group' => 'Console spazio',
                'description' => 'Configura ente, struttura, OID e certificati del Gateway FSE.',
                'route_prefixes' => ['spazio/fse2', 'login/spazio/fse2'],
            ],
            [
                'key' => 'spazio/invii-whatsapp',
                'link' => 'spazio/invii-massivi',
                'title' => 'Invii massivi',
                'icon' => 'fa-envelope',
                'order' => 2210,
                'group' => 'Console spazio',
                'description' => 'Campagne email e SMS con fallback, un invio al minuto.',
                'route_prefixes' => [
                    'spazio/invii-massivi',
                    'spazio/invii-massivi/create',
                    'login/spazio/invii-massivi',
                    'login/spazio/invii-massivi/create',
    ...
    public function platformConsoleCatalog(): array
    {
        return [
            ...
            [
                'key' => 'piattaforma/whatsapp',
                'link' => 'piattaforma/whatsapp',
                'title' => 'Registro WhatsApp',
                'icon' => 'fa-whatsapp',
                'order' => 550,
                'group' => 'Console piattaforma',
                'description' => 'Consulta le conversazioni WhatsApp separate per spazio cliente per assistenza e reclami.',
                'route_prefixes' => [
                    'login/piattaforma/whatsapp',
