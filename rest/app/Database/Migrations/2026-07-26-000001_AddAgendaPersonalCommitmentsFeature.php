...
class AddAgendaPersonalCommitmentsFeature extends Migration
{
    protected $DBGroup = 'platform';

    private const FEATURE_KEY = 'agenda_personal_commitments';
    ...
    public function up()
    {
        ...
        if ($this->db->fieldExists('icon_class', 'platform_features')) {
            $payload['icon_class'] = 'fa-calendar-times-o';
        }
        ...
        if ($this->db->fieldExists('icon_class', 'platform_features')) {
            $update['icon_class'] = 'fa-calendar-times-o';
        }
