    ...
    public function defaultConfig(): array
    {
        return [
            ...
            'branding' => [
                ...
                'header_extra' => '',
                'show_issuer_extra' => true,
                'show_issuer_name' => true,
                'show_issuer_address' => true,
                'show_issuer_tax_code' => true,
                'show_issuer_vat_number' => true,
                'show_issuer_pec' => true,
                'show_issuer_pension' => true,
                'header_document_number' => false,
                'header_issue_date' => false,
                'header_payment_method' => false,
                'header_payment_date' => false,
                'header_patient_name' => false,
                'header_patient_tax_code' => false,
                'header_patient_address' => false,
                'header_patient_city' => false,
                'header_patient_email' => false,
                'header_patient_phone' => false,
                'header_patient_mobile' => false,
                'show_header_metadata' => false,
                'show_header_opposition' => false,
                'footer_note' => '',
                'terms_text' => '',
            ],
            'layout' => [
            ...
            'fields' => [
                ...
                'show_issuer_address' => false,
                'show_issuer_tax_code' => false,
                'show_issuer_vat_number' => false,
                'show_issuer_pec' => false,
                'show_issuer_pension' => false,
                'show_issuer_extra' => false,
                'show_document_number' => true,
                'show_issue_date' => true,
                'show_patient_name' => true,
                'show_patient_tax_code' => true,
                'show_patient_address' => false,
                'show_patient_city' => false,
                'show_patient_email' => false,
                'show_patient_phone' => false,
                'show_patient_mobile' => false,
    ...
    private function sanitizeConfig($rawConfig): array
    {
        ...
        return [
            ...
            'document_title' => $this->sanitizeText(
                // The legacy preferences remain available when opening an older invoice.
            ...
            'defaults' => [
                ...
                'stamp_duty_amount' => $this->sanitizeDecimal($documentDefaults['stamp_duty_amount'] ?? 0, 0, 9999),
            ...
            'branding' => [
                ...
                'header_title' => $this->sanitizeText($branding['header_title'] ?? '', 0, ''),
                'header_subtitle' => $this->sanitizeText($branding['header_subtitle'] ?? '', 0, ''),
                'header_style' => ($branding['header_style'] ?? '') === 'plain' ? 'plain' : 'colored',
                'header_extra' => $this->sanitizeText($branding['header_extra'] ?? '', 0, ''),
                'show_issuer_extra' => $this->toBool($branding['show_issuer_extra'] ?? true),
                'show_issuer_name' => $this->toBool($branding['show_issuer_name'] ?? true),
                'show_issuer_address' => $this->toBool($branding['show_issuer_address'] ?? true),
                'show_issuer_tax_code' => $this->toBool($branding['show_issuer_tax_code'] ?? true),
                'show_issuer_vat_number' => $this->toBool($branding['show_issuer_vat_number'] ?? true),
                'show_issuer_pec' => $this->toBool($branding['show_issuer_pec'] ?? true),
                'show_issuer_pension' => $this->toBool($branding['show_issuer_pension'] ?? true),
                'header_document_number' => $this->toBool($branding['header_document_number'] ?? (!empty($branding['show_header_metadata']) && ($fields['show_document_number'] ?? true))),
                'header_issue_date' => $this->toBool($branding['header_issue_date'] ?? (!empty($branding['show_header_metadata']) && ($fields['show_issue_date'] ?? true))),
                'header_payment_method' => $this->toBool($branding['header_payment_method'] ?? (!empty($branding['show_header_metadata']) && ($fields['show_payment_method'] ?? true))),
                'header_payment_date' => $this->toBool($branding['header_payment_date'] ?? (!empty($branding['show_header_metadata']) && ($fields['show_payment_date'] ?? true))),
                'header_patient_name' => $this->toBool($branding['header_patient_name'] ?? false),
                'header_patient_tax_code' => $this->toBool($branding['header_patient_tax_code'] ?? false),
                'header_patient_address' => $this->toBool($branding['header_patient_address'] ?? false),
                'header_patient_city' => $this->toBool($branding['header_patient_city'] ?? false),
                'header_patient_email' => $this->toBool($branding['header_patient_email'] ?? false),
                'header_patient_phone' => $this->toBool($branding['header_patient_phone'] ?? false),
                'header_patient_mobile' => $this->toBool($branding['header_patient_mobile'] ?? false),
                'show_header_metadata' => $this->toBool($branding['show_header_metadata'] ?? false),
                'show_header_opposition' => $this->toBool($branding['show_header_opposition'] ?? false),
                'footer_note' => $this->sanitizeText($branding['footer_note'] ?? '', 0, ''),
                'terms_text' => $this->sanitizeText($branding['terms_text'] ?? '', 0, ''),
            ],
            'layout' => [
                ...
                'show_document_box' => $this->toBool($layout['show_document_box'] ?? true),
            ...
            'fields' => [
                'show_issuer_name' => $this->toBool($fields['show_issuer_name'] ?? false),
                'show_issuer_address' => $this->toBool($fields['show_issuer_address'] ?? false),
                'show_issuer_tax_code' => $this->toBool($fields['show_issuer_tax_code'] ?? false),
                'show_issuer_vat_number' => $this->toBool($fields['show_issuer_vat_number'] ?? false),
                'show_issuer_pec' => $this->toBool($fields['show_issuer_pec'] ?? false),
                'show_issuer_pension' => $this->toBool($fields['show_issuer_pension'] ?? false),
                'show_issuer_extra' => $this->toBool($fields['show_issuer_extra'] ?? false),
                ...
                'show_patient_address' => $this->toBool($fields['show_patient_address'] ?? false),
                'show_patient_city' => $this->toBool($fields['show_patient_city'] ?? false),
                'show_patient_email' => $this->toBool($fields['show_patient_email'] ?? false),
                'show_patient_phone' => $this->toBool($fields['show_patient_phone'] ?? false),
                'show_patient_mobile' => $this->toBool($fields['show_patient_mobile'] ?? false),
