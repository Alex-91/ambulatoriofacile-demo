...
class AddAgendaSkipEmptyDaysFeature extends Migration
{
    protected $DBGroup = 'platform';

    private const FEATURE_KEY = 'agenda_skip_empty_days';
    ...
    public function up()
    {
        ...
        if (!$feature) {
            ...
            if ($this->db->fieldExists('icon_class', 'platform_features')) {
                $payload['icon_class'] = 'fa-step-forward';
            }
            ...
            if ($this->db->fieldExists('icon_class', 'platform_features')) {
                $update['icon_class'] = 'fa-step-forward';
            }
