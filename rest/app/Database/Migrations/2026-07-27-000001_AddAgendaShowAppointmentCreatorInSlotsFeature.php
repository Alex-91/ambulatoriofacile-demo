...
class AddAgendaShowAppointmentCreatorInSlotsFeature extends Migration
{
    protected $DBGroup = 'platform';

    private const FEATURE_KEY = 'agenda_show_appointment_creator_in_slots';
