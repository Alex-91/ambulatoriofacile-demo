...
class AddAgendaCompressedLayoutFeature extends Migration
{
    protected $DBGroup = 'platform';

    private const FEATURE_KEY = 'agenda_compressed_layout';
    ...
    public function up()
    {
        ...
        if ($this->db->fieldExists('icon_class', 'platform_features')) {
            $payload['icon_class'] = 'fa-compress';
        }
