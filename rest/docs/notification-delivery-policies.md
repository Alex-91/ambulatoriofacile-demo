...
Per riallineare la schedulazione esistente usare `ops/setup-whatsapp-campaign-dispatch.ps1 -Target login`. Le campagne restano nella finestra 07:30–22:30 Europe/Rome. Le modifiche ai parametri vengono lette durante l'elaborazione anche per le campagne già accodate; una prenotazione di invio già registrata conserva la sua scadenza. Il piano di priorità salvato all'accodamento resta invariato. La pagina ricalcola invece la fine stimata a ogni apertura sui destinatari ancora in attesa, sulle campagne precedenti dello stesso spazio e sui limiti attuali, senza modificare l'ordine dei destinatari.
